...
output_folder = "outputs/max_accuracy"
num_samples = 10000
    ...
    for dataset_name in dataset_list:
        ...
        for multiple in multiples:
            ...
            for set_run in tqdm(range(num_sets)):
                ...
                max_accuracy = max(ordering_accuracies[set_run])
                all_max_accuracies.append(max_accuracy)

        # Output the CSV with 2 rows
        header_row = list(range(len(all_max_accuracies)))
        data_row = all_max_accuracies
        ...
        plt.boxplot(all_max_accuracies)
        ...
        plt.figure(figsize=(10, 6))
        plt.hist(all_max_accuracies, bins=20, edgecolor='black')
